...
import { Scissors, Video, Music, Type, Clapperboard, Plus } from "lucide-react";
                    ...
                    <CardContent className="flex-grow">
                        <Tabs defaultValue="media" className="h-full flex flex-col">
                            <TabsList className="grid w-full grid-cols-4">
                                ...
                                <TabsTrigger value="elements"><Clapperboard /></TabsTrigger>
                            </TabsList>
                            <TabsContent value="media" className="flex-grow mt-4">
                             ...
                             <TabsContent value="audio" className="flex-grow mt-4">
                                <div className="h-full border-2 border-dashed rounded-lg flex items-center justify-center text-muted-foreground p-4">
