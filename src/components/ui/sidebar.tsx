  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        "group-hover:opacity-100 group-hover:ml-0 group-hover:mt-0 group-hover:h-8 group-hover:p-2",
        "ml-1 mt-4 h-auto p-0 opacity-0",
        className
      )}
      {...props}
    />
